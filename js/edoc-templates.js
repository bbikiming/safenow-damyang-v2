...
(function () {
    ...
    const LAW_DICT = {
        ...
        '산업안전보건법 제64조': { law: '산업안전보건법', art: '제64조', clause: '', title: '도급에 따른 산업재해 예방조치', text: '도급인은 관계수급인 근로자가 도급인의 사업장에서 작업을 하는 경우 안전 및 보건에 관한 협의체의 구성·운영, 작업장 순회점검, 수급인 근로자에 대한 안전보건교육 지원·확인 등 산업재해 예방을 위한 조치를 하여야 한다.' },
    };
