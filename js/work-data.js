...
(function (global) {
     ...
     * 않는다. 연계 후에는 배치 스케줄러가 이 함수를 부르고, 프로토타입에서는
    ...
    /* ================= 예시 자료 ================= */
    /* 기준일(DYV2.today() = 2026-07-16)에 **전 상태가 한 화면에** 보이도록
    ...
    function seed() {
         ...
         * 기준일(2026-07-16) 기준으로 발행일 07-14 가 이미 지났으므로
         ...
         * 발행일 07-03 이 기준일보다 앞서므로 '발행일 도래'로 뜨고,
